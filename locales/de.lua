local Translations = {
    error = {
        ...
        impossible = 'Aktion unmöglich...',
        no_player = 'Kein Spieler in der nähe',
        no_firstaid = 'Du benötigst ein First Aid Kit',
        no_bandage = 'Du benötigst einen Verband',
        beds_taken = 'Betten sind belegt...',
        possessions_taken = 'Alle deine Besitztümmer wurden genommen...',
    ...
    progress = {
        ...
        painkillers = 'Schmerzmittel nehmen...',

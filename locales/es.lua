local Translations = {
    ...
    info = {
        ...
        respawn_revive = 'MANTÉN [E] DURANTE %{holdtime} SEGUNDOS PARA SER REVIVIDO POR $~r~{cost}~s~',
        bleed_out = 'TE DESANGRARAS EN ~r~{time}~s~ SEGUNDOS',
        bleed_out_help = 'TE DESANGRARAS EN ~r~{time}~s~ SEGUNDOS, PUEDES SER AYUDADO',

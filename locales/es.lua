local Translations = {
    ...
    info = {
        ...
        respawn_txt = 'REANIMACIÓN EN: %{deathtime} SEGUNDOS',
        respawn_revive = 'MANTÉN [E] DURANTE %{holdtime} SEGUNDOS PARA SER REANIMADO POR $%{cost}',
        bleed_out = 'PERDERÁS EL CONOCIMIENTO EN: %{time} SEGUNDOS',
        bleed_out_help = 'PERDERÁS EL CONOCIMIENTO EN: %{time} SEGUNDOS, PUEDES SER TRATADO',
        request_help = 'PULSA [G] PARA SER TRATADO',
        ...
        pain_message = 'Sientes %{severity} en el/la %{limb}',

...
Config.Locations = {
    ...
    ["beds"] = {
        [1] = {vector4(311.13, -582.89, 43.53, 335.65), taken = false, model = 1631638868},
        [2] = {vector4(313.96, -579.05, 43.53, 164.5), taken = false, model = 1631638868},
        [3] = {vector4(314.58, -584.09, 43.53, 335.65), taken = false, model = 1631638868},
        [4] = {vector4(317.74, -585.29, 43.53, 335.65), taken = false, model = 1631638868},
        [5] = {vector4(319.47, -581.04, 43.53, 164.5), taken = false, model = 1631638868}, 
        [6] = {vector4(366.43, -581.54, 43.28, 66.5), taken = false, model = 1631638868}, 
        [7] = {vector4(364.93, -585.86, 43.28, 67.5), taken = false, model = 1631638868}, 
        [8] = {vector4(363.82, -589.09, 43.28, 68.5), taken = false, model = 1631638868},
    }
}
